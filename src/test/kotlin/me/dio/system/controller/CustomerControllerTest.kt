...
class CustomerControllerTest {
    ...
    private fun builderCustomerDto(
        firstName: String = "Yan",
        lastName: String = "Pedro",
        cpf: String = "17662570677",
        email: String = "yan.pedro@email.com",
        income: BigDecimal = BigDecimal.valueOf(1700.0),
        password: String = "12345",
        zipCode: String = "54323508",
        street: String = "Rua Y",
    ) = CustomerDto(
        firstName = firstName,
        lastName = lastName,
    ...
    private fun builderCustomerUpdateDto(
        firstName: String = "YanUpdate",
        lastName: String = "PedroUpdate",
